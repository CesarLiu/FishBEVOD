...
DETECTION_NAMES = ['car', 'truck', 'bus', 'trailer', 'construction_vehicle', 'pedestrian', 'motorcycle', 'bicycle',
                   'traffic_cone', 'barrier','trafficsign']
...
DETECTION_COLORS = {'car': 'C0',
                    ...
                    'barrier': 'C9',
                    'trafficsign': 'C10'}
ATTRIBUTE_NAMES = ['dynamic.static',
                  'dynamic.dynamic', 'category.stuff', 'category.instance']
PRETTY_ATTRIBUTE_NAMES = {'dynamic.static': 'Static',
                            'dynamic.dynamic': 'Dynamic',
                            'category.stuff': 'Static Stuff',
                            'category.instance': 'Static Object'}
