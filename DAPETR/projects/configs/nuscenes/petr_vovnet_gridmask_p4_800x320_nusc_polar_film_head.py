...
data = dict(
    ...
    val=dict(type=dataset_type, data_root=data_root,
             ann_file=data_root + 'nuscenes2d_ego_temporal_infos_val.pkl', pipeline=test_pipeline, classes=class_names, modality=input_modality),
...
# load_from= 'work_dirs/petr_vovnet_gridmask_p4_1408x376_fish_filmfpe_11k/latest.pth'
resume_from=None
# mAP: 0.3778
# mATE: 0.7463
# mASE: 0.2718
