...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'bevformer_infos_temporal_train.pkl',
...
evaluation = dict(interval=2, pipeline=test_pipeline,  out_dir='./work_dirs' )
find_unused_parameters=False

runner = dict(type='EpochBasedRunner', max_epochs=total_epochs)
load_from='ckpts/fcos3d_vovnet_imgbackbone-remapped.pth'
# resume_from = 'work_dirs/petr_vovnet_gridmask_p4_1408x376_fish_film/epoch_2.pth'
