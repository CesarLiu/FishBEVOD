...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'selected_with_target_classes_train_11k.pkl',
...
resume_from='work_dirs/petr_vovnet_gridmask_p4_1408x376_fish_sasa_11k/latest.pth'
