...
load_from= 'work_dirs/petr_vovnet_gridmask_p4_1408x376_fish/latest.pth'#'ckpts/fcos3d_vovnet_imgbackbone-remapped.pth'
resume_from = 'work_dirs/petr_vovnet_gridmask_p4_1408x376_fish_polar_ft/latest.pth'
