...
model = dict(
    type='Petr3D',
    use_grid_mask=True,
    fisheye_aug=dict(enabled=True, add_angles=True),
    img_backbone=dict(
        type='VoVNetCP',
        spec_name='V-99-eSE',
        norm_eval=True,
...
load_from='work_dirs/petr_vovnet_gridmask_p4_1408x376_fish_bb/latest.pth'
# load_from='ckpts/fcos3d_vovnet_imgbackbone-remapped.pth'
# resume_from = 'work_dirs/petr_vovnet_gridmask_p4_1408x376_fish_bb/latest.pth'
