...
class PETRHead(AnchorFreeHead):
    ...
    def _init_layers(self):
        ...
        if self.with_film:
            ...
            # )
            self.film = MultiModalDistortionFiLM_FP16(
                feature_dim=self.embed_dims,
                use_unified_encoder=False
            )
    ...
    def position_embeding(self, img_feats, img_metas, masks=None):
        ...
        if self.with_distortion:
            ...
            dist_coords_2d = coords_2d[..., :3] / coords_2d[..., 2:3]  # [B, N, W, H, 3]
        ...
        # print('shape of coords_position_embeding: ', coords_position_embeding.shape)
        # print('shape of dist_coords_2d: ', dist_coords_2d.shape)
        # print('shape of coords_mask: ', coords_mask.shape)
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        if self.with_sasa:
            ...
            outs_dec, _ = self.transformer(x, masks, query_embeds, pos_embed, reference_points, None, self.reg_branches)
        else:
            query_embeds = self.query_embedding(pos2posemb3d(reference_points))
            reference_points = reference_points.unsqueeze(0).repeat(batch_size, 1, 1) #.sigmoid()
