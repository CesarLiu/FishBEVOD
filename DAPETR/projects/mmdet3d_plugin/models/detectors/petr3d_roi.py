...
class Petr3DROI(MVXTwoStageDetector):
    """Petr3DROI."""
    ...
    def __init__(self,
                 ...
                 stride=16,
                 pretrained=None):
        super(Petr3DROI, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def forward_pts_train(self,
        ...
        if self.with_img_roi_head:
            # print('length of img_feats:', len(pts_feats))
            location = self.prepare_location(img_metas, pts_feats[0])
            outs_roi = self.img_roi_head(location, pts_feats[0])
