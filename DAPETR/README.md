...
CUDA_VISIBLE_DEVICES=3,4,5,6 bash tools/dist_test.sh projects/configs/denoise/petr_vovnet_gridmask_p4_800x320_dn.py /home/xliu/WACV2026/PETR/work_dirs/petr_vovnet_gridmask_p4_800x320_dn/latest.pth 4 --eval bbox

CUDA_VISIBLE_DEVICES=5,6 bash tools/dist_train.sh projects/configs/denoise/petr_vovnet_gridmask_p4_800x320_dn.py 2

docker run --gpus all -itd -v /data02/bmw_cv:/home/xliu -v /data03/datasets:/home/datasets -v /data02:/home/data02 -v /data01:/home/data01    --shm-size=128G  xliu/cuda:11.1.1-cudnn8-devel-ubuntu20.04-cv /bin/bash

CUDA_VISIBLE_DEVICES=0,1,2 bash tools/dist_test.sh projects/configs/denoise/petr_vovnet_gridmask_p4_1408x376_dn_kitti360_rect.py /home/xliu/WACV2026/PETR/ckpts/epoch_24.pth 3 --eval bbox
