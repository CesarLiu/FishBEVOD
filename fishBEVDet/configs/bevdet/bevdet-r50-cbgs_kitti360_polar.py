...
# load_from = 'work_dirs/bevdet-r50-cbgs_kitti360_polar/epoch_14.pth'
# fp16 = dict(loss_scale='dynamic')
# workflow = [('train', 1), ('val', 1)]
# resume_from = 'work_dirs/bevdet-r50-cbgs_kitti360_polar_nocbgs/latest.pth'
total_epochs = 18
