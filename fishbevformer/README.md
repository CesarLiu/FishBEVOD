...
# Visualization
Several visualization tools are provided to visualize the detection results of BEVFormer and other methods. Please refer to [visualization](tools/analysis_tools) for more details.
```
  python visual_xxx.py \
    --result_json_lidar xxx/lidar_results_nusc.json \
    --result_json_camera xxx.json \
    --output_dir ./vis_results_lidar_cam \
