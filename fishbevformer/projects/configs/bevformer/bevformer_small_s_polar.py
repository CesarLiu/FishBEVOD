...
data = dict(
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'bevformer_infos_temporal_val.pkl',
...
load_from = 'work_dirs/bevformer_small_s_polar_old/epoch_20.pth'
log_config = dict(
    interval=50,
    hooks=[
...
# resume_from = 'work_dirs/bevformer_small_s_polar/latest.pth'
