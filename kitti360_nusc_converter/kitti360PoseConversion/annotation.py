...
class KITTI360Bbox3D(KITTI360Object):
    ...
    def __init__(self):
        ...
        self.vertices  = []
        self.faces  = []
        self.lines = [[0,5],[1,4],[2,7],[3,6], #length
                      [0,1],[1,3],[3,2],[2,0], #front face, clockwise
                      [4,5],[5,7],[7,6],[6,4]] #back face, anticlockwise
        ...
        # timestamp of the bbox (-1 if statics)
        self.timestamp = -1
