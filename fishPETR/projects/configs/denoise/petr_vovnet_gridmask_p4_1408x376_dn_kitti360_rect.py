...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'bevformer_pinhole_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type, data_root=data_root,
             ann_file=data_root + 'mini_bevformer_pinhole_infos_temporal_val.pkl', pipeline=test_pipeline, classes=class_names, modality=input_modality),
