...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        normedlinear=False,
        # use_proj_loss=True,  # Enable projection loss
        # proj_loss_weight=1.0,
        transformer=dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'bevformer_3d_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type, data_root=data_root,
             ann_file=data_root + 'bevformer_3d_infos_temporal_val.pkl', pipeline=test_pipeline, classes=class_names, modality=input_modality),
...
# resume_from='work_dirs/petr_vovnet_gridmask_p4_800x320_dn/latest.pth'
